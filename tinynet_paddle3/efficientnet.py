...
def efficientnet_params(model_name):
    ...
    params_dict = {
        ...
        'efficientnet-b0': (0.54, 0.85, 184.8, 0.2),
        'efficientnet-b1': (1.0, 1.1, 240, 0.2),
        'efficientnet-b2': (0.5, 0.85, 184.8, 0.2),
...
def efficientnet(width_coefficient=None,
    ...
    blocks_args = [
        'r1_k3_s11_e1_i64_o16_se0.25',
        'r2_k3_s22_e6_i16_o24_se0.25',
        'r2_k5_s22_e6_i24_o40_se0.25',
        'r3_k3_s22_e6_i40_o80_se0.25',
        'r3_k5_s11_e6_i80_o112_se0.25',
        'r3_k5_s22_e6_i112_o192_se0.25',
...
class ExpandConvNorm(nn.Layer):                                 #expand变胖卷积层
    def __init__(self,
                 input_channels,
                 block_args,
                 padding_type,
...
class DepthwiseConvNorm(nn.Layer):                      #DW卷积层
    def __init__(self,
                 input_channels,
                 block_args,
                 padding_type,
...
class SEBlock(nn.Layer):                              #SEB注意力模块
    def __init__(self,
                 input_channels,
...
class MbConvBlock(nn.Layer):              #MB卷积模块
    def __init__(self,
                 input_channels,
                 block_args,
                 padding_type,
...
class ExtractFeatures(nn.Layer):             #提取特征，应该是第一层
    def __init__(self,
                 input_channels,
                 _block_args,
                 _global_params,
...
class EfficientNet(nn.Layer):                    #efficient网络
    def __init__(self,
                 name="b0",
                 padding_type="SAME",
        ...
        output_channels = 1280#round_filters(1280, self._global_params)      #应该是硬编码
